                                                   ...
                                                   const u8 *ssi, size_t ssi_len)
{
	...
	/* Send NANDiscoveryResult signal */
}
                                                      ...
                                                      int publish_id, enum nan_de_reason reason)
{
	wpa_msg_global(wpa_s, MSG_INFO, NAN_PUBLISH_TERMINATED
                   "publish_id=%d reason=%s", publish_id, nan_reason_txt(reason));
	/* Send NANPublishTerminated signal */
}
                                                        ...
                                                        enum nan_de_reason reason)
{
    wpa_msg_global(wpa_s, MSG_INFO, NAN_SUBSCRIBE_TERMINATED
                   "subscribe_id=%d reason=%s", subscribe_id, nan_reason_txt(reason));
    /* Send NANSubscribeTerminated signal */
}
